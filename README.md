...
`bin/s2t` is the entrypoint. Add this repo’s `bin/` to your `PATH` or symlink it somewhere in your `PATH`.
...
ln -sf /home/juan/projects/s2t/systemd/user/s2t.service ~/.config/systemd/user/s2t.service
